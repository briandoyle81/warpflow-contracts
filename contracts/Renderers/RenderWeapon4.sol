...
contract RenderWeapon4 {
    ...
    string private constant COLOR_3 = 'hsl(50, 5%, 54%)';
    string private constant COLOR_4 = 'hsl(184, 64%, 47%)';
    string private constant COLOR_5 = 'hsl(186, 63%, 45%)';
    string private constant COLOR_6 = 'hsl(47, 6%, 43%)';
    string private constant COLOR_7 = 'hsl(187, 77%, 35%)';
    string private constant COLOR_8 = 'hsl(80, 2%, 34%)';
    string private constant COLOR_9 = 'hsl(180, 2%, 24%)';
    string private constant COLOR_10 = 'hsl(200, 15%, 20%)';
    string private constant COLOR_11 = 'hsl(207, 12%, 18%)';
    string private constant COLOR_12 = 'hsl(210, 9%, 14%)';
    string private constant COLOR_13 = 'hsl(214, 14%, 10%)';
    string private constant COLOR_14 = 'hsl(210, 24%, 8%)';
    string private constant COLOR_15 = 'hsl(216, 15%, 6%)';
